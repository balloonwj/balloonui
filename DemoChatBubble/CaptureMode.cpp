...
// Writes a single line to %TEMP%\DemoChatBubble.log AND OutputDebugString.
...
{
public:
    DECLARE_WND_CLASS_EX(_T("__DemoChatBubbleOwner__"),
                  ...
                  std::function<std::unique_ptr<DuiControl>()> buildContent)
{
    ...
    static const TCHAR kClassName[] = _T("__DemoChatBubbleOwner__");
