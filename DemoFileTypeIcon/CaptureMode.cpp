...
// Writes a single line to %TEMP%\DemoFileTypeIcon.log AND OutputDebugString.
...
{
public:
    DECLARE_WND_CLASS_EX(_T("__DemoFileTypeIconOwner__"),
                  ...
                  std::function<std::unique_ptr<DuiControl>()> buildContent)
{
    ...
    static const TCHAR kClassName[] = _T("__DemoFileTypeIconOwner__");
