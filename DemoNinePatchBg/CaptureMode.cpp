...
// Writes a single line to %TEMP%\DemoNinePatchBg.log AND OutputDebugString.
...
// Canvas 大小 — DemoNinePatchBg 演示 4 个不同尺寸的 9-grid tile，
// 加上各种说明文字 + 反例，纵向 ~1400 像素。1500 留点余量。
const int kCanvasW = 1000;
const int kCanvasH = 1500;
...
{
public:
    DECLARE_WND_CLASS_EX(_T("__DemoNinePatchBgOwner__"),
                  ...
                  std::function<std::unique_ptr<DuiControl>()> buildContent)
{
    ...
    static const TCHAR kClassName[] = _T("__DemoNinePatchBgOwner__");
