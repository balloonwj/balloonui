...
// Writes a single line to %TEMP%\DemoCircularProgress.log AND OutputDebugString.
...
{
public:
    DECLARE_WND_CLASS_EX(_T("__DemoCircularProgressOwner__"),
                  ...
                  std::function<std::unique_ptr<DuiControl>()> buildContent)
{
    ...
    static const TCHAR kClassName[] = _T("__DemoCircularProgressOwner__");
